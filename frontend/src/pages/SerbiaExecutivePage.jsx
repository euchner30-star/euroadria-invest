          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center space-x-2 bg-ea-gold/20 border border-ea-gold/40 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-ea-gold text-sm font-medium">Exklusives Netzwerk</span>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-semibold font-bold text-ea-dark mb-4">
              Exklusive <span className="text-ea-gold">Leistungen</span>
            </h2>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8 md:p-10 shadow-sm hover:shadow-md transition-shadow" data-testid="service-government">
              <div className="grid md:grid-cols-3 gap-8">
                <div>
                  ...
                  <p className="text-ea-gold font-medium">Zugang zu serbischen Behörden</p>
                </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8 md:p-10 shadow-sm hover:shadow-md transition-shadow" data-testid="service-infrastructure">
              <div className="grid md:grid-cols-3 gap-8">
                <div>
                  ...
                  <p className="text-ea-gold font-medium">Großprojekte & Partnerschaften</p>
                </div>
                <div className="md:col-span-2 space-y-4">
                  <p className="text-ea-dark/70 leading-relaxed">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8 md:p-10 shadow-sm hover:shadow-md transition-shadow" data-testid="service-incentives">
              <div className="grid md:grid-cols-3 gap-8">
                <div>
                  ...
                  <p className="text-ea-gold font-medium">Staatliche Förderungen</p>
                </div>
                <div className="md:col-span-2 space-y-4">
                  <p className="text-ea-dark/70 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white border border-gray-200 p-8 rounded-2xl shadow-sm">
              <p className="text-ea-gold text-sm font-medium mb-4">EXKLUSIV FÜR DACH-INVESTOREN</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-ea-dark/60 text-sm">CEO, Mittelständisches Unternehmen, München</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" required value={inquiryForm.name} onChange={(e) => handleChange('name', e.target.value)} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#3eb489]/20 focus:border-ea-gold transition-colors" placeholder="Ihr Name" data-testid="inquiry-name" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-ea-dark/80 mb-2">Unternehmen</label>
                  <input type="text" value={inquiryForm.company} onChange={(e) => handleChange('company', e.target.value)} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#3eb489]/20 focus:border-ea-gold transition-colors" placeholder="Ihr Unternehmen" data-testid="inquiry-company" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-ea-dark/80 mb-2">E-Mail *</label>
                  <input type="email" required value={inquiryForm.email} onChange={(e) => handleChange('email', e.target.value)} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#3eb489]/20 focus:border-ea-gold transition-colors" placeholder="ihre@email.de" data-testid="inquiry-email" />
                </div>
                <div>
              ...
              <div>
                <label className="block text-sm font-medium text-ea-dark/80 mb-2">Interessengebiet</label>
              ...
              <div>
                ...
                <textarea rows={4} value={inquiryForm.message} onChange={(e) => handleChange('message', e.target.value)} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#3eb489]/20 focus:border-ea-gold transition-colors resize-none" placeholder="Beschreiben Sie kurz Ihr Anliegen..." data-testid="inquiry-message" />
              </div>
