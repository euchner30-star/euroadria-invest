...
const Home = () => {
  ...
  return (
    <main className="min-h-screen bg-white" itemScope itemType="https://schema.org/WebPage">
      ...
      {/* Trust Bar - wie euroadria.me */}
      <section className="py-4 bg-ea-dark border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            ...
            <div className="flex items-center gap-6 text-sm text-ea-light/70">
              <a href="tel:+38268559776" className="flex items-center gap-2 hover:text-ea-gold transition-colors">
