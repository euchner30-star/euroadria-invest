...
const SkadarLakePage = () => {
  ...
  useEffect(() => {
    fetch(`${process.env.REACT_APP_BACKEND_URL || ''}/api/settings/downloads`)
      .then(res => res.json())
      .then(data => setExposeUrl(data.skadar_lake_expose_url || ''))
      .catch(() => {});
  }, []);
  ...
  const investmentHighlights = [
    { icon: TrendingUp, label: 'Investment-Score', value: '88/100', description: 'Hoher Aufwertungshebel' },
    { icon: Euro, label: 'Durchschnittspreis', value: '€800-1.500/m²', description: 'Unter Küstenniveau' },
    { icon: Clock, label: 'Zeithorizont', value: '3-7 Jahre', description: 'Mittelfristig' },
    { icon: Building2, label: 'Potenzial', value: '+40-60%', description: 'Erwartete Wertsteigerung' },
  ];

  const infrastructureAdvantages = [
    'Neue Umgehungsstraße Bar-Boljare (2025)',
    'Flughafen Podgorica in 30 Min. erreichbar',
    'UNESCO-Welterbe-Kandidatur',
    'Nationalpark-Schutzstatus',
    'EU-finanzierte Öko-Tourismus-Projekte',
    'Neue Marina-Entwicklungen geplant',
  ];
  ...
  return (
    <div className="min-h-screen bg-white" data-testid="skadar-lake-page">
      <SEO 
        ...
        description="Exklusive Immobilien-Investments am Skadar-See, Montenegros größtem See. Investment-Score 88/100, €800-1.500/m², +40-60% Wertsteigerungspotenzial."
        url="/immobilien/skadar-lake"
      />
      ...
      <header className="pt-28 pb-16 px-6 bg-gradient-to-b from-ea-light to-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-ea-gold text-sm font-semibold tracking-wider uppercase mb-4">
            ...
            <span>Montenegro • Südosten</span>
          </div>
          
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-ea-dark mb-6 leading-tight">
            Skadar-Lake: <span className="text-ea-gold">Naturparadies</span><br />
            mit Investment-Potenzial
          </h1>
          
          <p className="text-ea-dark/70 text-lg md:text-xl max-w-3xl mb-8 leading-relaxed">
            Der Skadar-See ist der größte See der Balkanhalbinsel und bietet als UNESCO-Welterbe-Kandidat 
            einzigartige Investment-Chancen im Bereich Öko-Tourismus und Premium-Wohnimmobilien.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-semibold text-ea-dark mb-6">
                Warum <span className="text-ea-gold">Skadar-Lake</span>?
              </h2>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-ea-dark mb-1">Nationalpark & UNESCO-Status</h3>
                    <p className="text-ea-dark/70 text-sm">Geschützte Lage garantiert langfristigen Wert und limitiertes Bauland.</p>
                  </div>
                </div>
                
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-ea-gold/10 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Fish className="w-5 h-5 text-ea-gold" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-ea-dark mb-1">Öko-Tourismus Boom</h3>
                    <p className="text-ea-dark/70 text-sm">Wachsender Markt für nachhaltige Ferienwohnungen und Boutique-Hotels.</p>
                  </div>
                </div>
                
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-ea-gold/10 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Droplets className="w-5 h-5 text-ea-gold" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-ea-dark mb-1">Unberührte Natur</h3>
                    <p className="text-ea-dark/70 text-sm">270 Vogelarten, kristallklares Wasser, mediterran-balkanische Flora.</p>
                  </div>
                </div>
              </div>

              <div className="bg-white border border-ea-gold/20 rounded-xl p-6">
                <p className="text-ea-gold font-semibold text-sm mb-2">EXPERTEN-EINSCHÄTZUNG</p>
      ...
      {/* Apartments Section - Placeholder for Future Listings */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-ea-dark/70 max-w-2xl mx-auto">
              Exklusive Off-Market Objekte für DACH-Investoren. Kontaktieren Sie uns für aktuelle Angebote.
            </p>
          </div>
            ...
            {[1, 2, 3].map((idx) => (
              ...
              >
                ...
                <p className="text-ea-dark/50 text-sm mb-4">
                  Neue Objekte in Vorbereitung. Registrieren Sie sich für exklusiven Erstzugang.
                </p>
                <button
                  onClick={() => setShowContactForm(true)}
          ...
          <div className="text-center">
            <button
              ...
              data-testid="apartments-contact-cta"
            >
      ...
      <section className="py-16 px-6 bg-ea-dark">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-semibold text-white mb-6">
            Interesse an <span className="text-ea-gold">Skadar-Lake</span>?
          </h2>
          <p className="text-ea-light/70 text-lg mb-8 max-w-2xl mx-auto">
            Erhalten Sie ein detailliertes Standort-Exposé mit aktuellen Marktdaten, 
            Preisentwicklungen und Investment-Empfehlungen.
          </p>
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl p-8 max-w-lg w-full max-h-[90vh] overflow-auto shadow-2xl">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-ea-dark">Skadar-Lake Exposé</h3>
                <p className="text-ea-dark/60 text-sm">Detaillierte Standort-Analyse anfordern</p>
              </div>
            </div>
