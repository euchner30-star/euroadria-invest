...
const BudvaPage = () => {
    ...
    try {
      await fetch(`${process.env.REACT_APP_BACKEND_URL || ''}/api/contact`, {
        ...
        body: JSON.stringify({
          ...
          subject: 'Immobilien-Anfrage: Budva',
          message: formData.message || 'Interesse an Immobilien in Budva.'
        })
      });
  ...
  const investmentHighlights = [
    { icon: TrendingUp, label: 'Investment-Score', value: '82/100', description: 'Etablierter Markt' },
    { icon: Euro, label: 'Durchschnittspreis', value: '€2.500-5.000/m²', description: 'Premium-Küstenlage' },
    { icon: Clock, label: 'Zeithorizont', value: '1-3 Jahre', description: 'Kurzfristig' },
    { icon: Building2, label: 'Mietrendite', value: '5-8%', description: 'Netto p.a.' },
  ];
  ...
  return (
    ...
    <div className="min-h-screen bg-white" data-testid="budva-page">
      <SEO 
        ...
        description="Premium-Küstenimmobilien in Budva, Montenegros Tourismus-Hotspot. Investment-Score 82/100, €2.500-5.000/m², 5-8% Mietrendite."
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap gap-4">
            {exposeUrl ? (
              <ExposeLeadGate
                exposeUrl={exposeUrl}
                exposeName="Budva Exposé"
                sourceId="budva_expose"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-semibold text-ea-dark mb-6">
                Warum <span className="text-ea-gold">Budva</span>?
              </h2>
              
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-ea-gold/10 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Waves className="w-5 h-5 text-ea-gold" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-ea-dark mb-1">Premium-Küstenlage</h3>
                    <p className="text-ea-dark/70 text-sm">35 km Sandstrände, kristallklares Wasser, mediterranes Klima.</p>
                  </div>
                </div>
                
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-ea-gold/10 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Sun className="w-5 h-5 text-ea-gold" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-ea-dark mb-1">Etablierter Tourismus</h3>
                    <p className="text-ea-dark/70 text-sm">2 Mio. Besucher jährlich, 6-Monats-Saison, hohe Nachfrage.</p>
                  </div>
                </div>
                
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-ea-gold/10 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Palmtree className="w-5 h-5 text-ea-gold" />
                  </div>
                  <div>
              ...
              <div className="bg-white border border-ea-gold/20 rounded-xl p-6">
                <p className="text-ea-gold font-semibold text-sm mb-2">RENDITE-FOKUS</p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-ea-dark/70 max-w-2xl mx-auto">
              Apartments, Penthouses und Villen mit Meerblick. Kontaktieren Sie uns für aktuelle Off-Market Angebote.
            </p>
          </div>
            ...
            {[1, 2, 3].map((idx) => (
              ...
              >
                ...
                <p className="text-ea-dark/50 text-sm mb-4">
                  Premium-Objekte in Vorbereitung.
                </p>
                <button
                  onClick={() => setShowContactForm(true)}
      ...
      <section className="py-16 px-6 bg-ea-dark">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-semibold text-white mb-6">
            Interesse an <span className="text-ea-gold">Budva</span>?
          </h2>
          <p className="text-ea-light/70 text-lg mb-8 max-w-2xl mx-auto">
            Erhalten Sie unsere Küsten-Investment-Analyse mit Mietrendite-Kalkulation, 
            Marktvergleich und Due-Diligence-Checkliste.
          </p>
          ...
          <div className="bg-white rounded-2xl p-8 max-w-lg w-full max-h-[90vh] overflow-auto shadow-2xl">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 bg-ea-gold/10 rounded-xl flex items-center justify-center">
                <Waves className="w-6 h-6 text-ea-gold" />
              </div>
              <div>
                <h3 className="text-xl font-bold text-ea-dark">Budva Exposé</h3>
                <p className="text-ea-dark/60 text-sm">Küsten-Investment-Analyse</p>
              </div>
            </div>
