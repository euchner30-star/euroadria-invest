    ...
    try {
      await fetch(`${process.env.REACT_APP_BACKEND_URL || ''}/api/contact`, {
        ...
        body: JSON.stringify({
          ...
          subject: 'Immobilien-Anfrage: Žabljak',
          message: formData.message || 'Interesse an Immobilien in Žabljak.'
        })
      });
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap gap-4">
            {exposeUrl ? (
              <ExposeLeadGate
                exposeUrl={exposeUrl}
                exposeName="Žabljak Exposé"
                sourceId="zabljak_expose"
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {exposeUrl ? (
              <ExposeLeadGate
                exposeUrl={exposeUrl}
                exposeName="Žabljak Dossier"
                sourceId="zabljak_expose"
                buttonText="Kostenloses Dossier herunterladen"
