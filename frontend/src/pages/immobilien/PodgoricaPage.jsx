...
const PodgoricaPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white" data-testid="podgorica-page">
      ...
      <section className="py-16 px-6 bg-white" id="apartments"><div className="max-w-7xl mx-auto"><div className="text-center mb-12"><h2 className="text-3xl md:text-4xl font-semibold text-ea-dark mb-4">{en?<>Available <span className="text-ea-gold">Properties</span></>:<>Verfügbare <span className="text-ea-gold">Immobilien</span></>}</h2><p className="text-ea-dark/70 max-w-2xl mx-auto">{en?'City apartments, office spaces and residential complexes. Contact us for current off-market offers.':'City-Apartments, Büroflächen und Wohnanlagen. Kontaktieren Sie uns für aktuelle Off-Market Angebote.'}</p></div><LocationProperties location="Podgorica" en={en} /></div></section>
