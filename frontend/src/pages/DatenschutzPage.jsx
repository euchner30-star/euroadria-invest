        ...
        <div className="space-y-6 animate-slideUp">
          ...
          <section className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-2xl font-semibold font-bold text-ea-dark">1. Verantwortliche Stelle</h2>
            </div>
            ...
            <div className="bg-ea-light rounded-xl p-6 space-y-4">
              ...
              <div className="border-l-4 border-ea-gold pl-4">
          ...
          <section className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-14 h-14 rounded-xl bg-ea-gold/10 flex items-center justify-center">
                <Database className="w-7 h-7 text-ea-gold" />
              </div>
              <h2 className="text-2xl font-semibold font-bold text-ea-dark">2. Erhebung und Speicherung personenbezogener Daten</h2>
            </div>
            
            <div className="space-y-4">
              <div className="bg-ea-light rounded-xl p-6">
                <h3 className="text-lg font-semibold text-ea-gold mb-4">a) Beim Besuch der Website</h3>
                <p className="text-ea-dark/70 mb-4 leading-relaxed">
                ...
                <ul className="list-disc list-inside text-ea-dark/70 space-y-2 mb-4 pl-2">
              ...
              <div className="bg-ea-light rounded-xl p-6">
                <h3 className="text-lg font-semibold text-ea-gold mb-4">b) Kontaktaufnahme</h3>
                <p className="text-ea-dark/70 leading-relaxed">
              ...
              <div className="bg-ea-light rounded-xl p-6">
                <h3 className="text-lg font-semibold text-ea-gold mb-4">c) Newsletter</h3>
                <p className="text-ea-dark/70 leading-relaxed">
          ...
          <section className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
            <h2 className="text-2xl font-semibold font-bold text-ea-dark mb-6">3. Weitergabe von Daten</h2>
            <div className="bg-ea-light rounded-xl p-6">
              <p className="text-ea-dark/70 mb-4 leading-relaxed">
                Eine Übermittlung Ihrer Daten an Dritte erfolgt nur, wenn:
              </p>
              <ul className="list-disc list-inside text-ea-dark/70 space-y-2 pl-2">
          ...
          <section className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-14 h-14 rounded-xl bg-ea-gold/10 flex items-center justify-center">
                <Cookie className="w-7 h-7 text-ea-gold" />
              </div>
              <h2 className="text-2xl font-semibold font-bold text-ea-dark">4. Cookies und Tracking</h2>
            </div>
            <div className="bg-ea-light rounded-xl p-6">
              <p className="text-ea-dark/70 mb-4 leading-relaxed">
          ...
          <section className="bg-ea-gold/5 border border-ea-gold/20 rounded-2xl p-8">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-14 h-14 rounded-xl bg-ea-gold/15 flex items-center justify-center">
                <FileText className="w-7 h-7 text-ea-gold" />
              </div>
              <h2 className="text-2xl font-semibold font-bold text-ea-dark">5. Ihre Rechte</h2>
            </div>
            <p className="text-ea-dark/80 leading-relaxed mb-4">Sie haben das Recht:</p>
            <ul className="space-y-3 text-ea-dark/70">
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 rounded-full bg-ea-gold mt-2 flex-shrink-0"></span>
          ...
          <section className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-14 h-14 rounded-xl bg-ea-gold/10 flex items-center justify-center">
                <Lock className="w-7 h-7 text-ea-gold" />
              </div>
              <h2 className="text-2xl font-semibold font-bold text-ea-dark">6. Datensicherheit</h2>
            </div>
            <p className="text-ea-dark/70 leading-relaxed">
          ...
          {/* 7. Aktualität */}
          <section className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
            <h2 className="text-2xl font-semibold font-bold text-ea-dark mb-6">7. Aktualität der Datenschutzerklärung</h2>
            <div className="bg-ea-light rounded-xl p-6">
              <p className="text-ea-dark/70 leading-relaxed">
                Diese Datenschutzerklärung ist aktuell gültig und hat den Stand <strong className="text-ea-gold">März 2026</strong>.
              </p>
            </div>
          </section>
        </div>
