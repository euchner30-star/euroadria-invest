      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div className="flex items-center gap-4">
            ...
            <span className="text-xs text-ea-gold bg-ea-gold/10 border border-ea-gold/30 px-3 py-1 rounded-full font-medium">{lang === 'en' ? 'Featured on n-tv, RTL, Focus, VC Magazin & Kosmo (Advertorial)' : 'Bekannt aus n-tv, RTL, Focus, VC Magazin & Kosmo (Anzeige)'}</span>
          </div>
