...
const Footer = () => {
  ...
  return (
    <footer className="bg-ea-dark py-16 mt-20">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <a href="mailto:office@euroadria.me" className="text-ea-light/70 hover:text-ea-gold transition-colors text-sm">
                  office@euroadria.me
                </a>
              </li>
              <li className="flex items-start space-x-3">
                <Phone className="w-5 h-5 text-ea-light/70 flex-shrink-0 mt-0.5" />
                <a href="tel:+38268559776" className="text-ea-light/70 hover:text-ea-gold transition-colors text-sm">
                  +382 68 559 776
                </a>
              </li>
            </ul>
