...
if ADMIN_USERNAME == 'admin' and ADMIN_PASSWORD == 'euroadria2025' and os.environ.get('RENDER'):
    logger.warning("⚠️ Using default admin credentials — set ADMIN_USERNAME and ADMIN_PASSWORD in env vars!")
